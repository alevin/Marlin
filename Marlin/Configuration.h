...
#define STRING_CONFIG_H_AUTHOR "HyperCube Marlin" // Original author or contributor.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -30, 20, 0 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
